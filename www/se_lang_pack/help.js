...
hsetup.phase1="Skärmen <i>Konfiguration</i>  \
		...
		på den här skärmen. Vissa Internet-leverantörer kräver \
...
hsetup.phase4="MTU står för \
    		...
    		MTU-storlek väljer du <b>Manuellt</b> och anger sedan önskat värde (standardvärdet är <b> \ b> \
    		1400</b>).&nbsp; Du bör ange ett värde mellan 1200 och 1500.";
...
hsetup.phase15="Du får IP-adressen till DNS-servern från Internet-leverantören.";
...
hsetup.phase19="Du kan konfigurera routern så att \
   		...
   		igen. Om du vill aktivera Anslut på begäran klickar du på alternativknappen. Om \
    		du vill att Internet-anslutningen ska vara aktiv hela tiden anger du <b>0</b> i fältet <i>Maximal vilotid</i>. Annars anger du efter hur många minuters \
...
hsetup.phase25="Det här är\
    		routerns IP-adress och nätmask som visas på det interna nätverket. På skärmen \
...
hsetup.phase33="DNS \
    		...
    		här. Routern använder dem för att snabbare komma åt fungerande DNS- \
    		servrar.";
hsetup.phase34="WINS (Windows Internet Naming Service) hanterar varje dators samspel med \
    		...
    		Annars anger du inget i fältet.";
...
helpddns.phase1="Det finns en DDNS-funktion (Dynamic Domain Name System) på routern. Med DDNS kan du tilldela ett fast \
		...
		du använder den här funktionen måste du registrera dig för DDNS-tjänsten på <i>www.dyndns.org<s.org</i> \
		en DDNS-leverantör.";
...
helpddns.phase9="Status för anslutningen till DDNS-tjänsten.";
		
//MAC Address Clone
var helpmac =  new Object();
helpmac.phase1="MAC-kloning";
helpmac.phase2="Routerns MAC-adress är en 12-siffrig kod som tilldelas en unik del av \
    		maskinvara för identifiering. Vissa Internet-leverantörer kräver att du registrerar MAC-adressen \
    		det nätverkskort/den nätverksadapter som var ansluten till ditt kabel- eller \
    		DSL-modem under installationen. Om Internet-leverantören kräver att du registrerar din MAC-adress- \
    		registrering, hittar du adapterns MAC-adress genom att följa \
    		instruktionerna för datorns operativsystem.";
...
helpmac.phase13="Om du vill klona nätverkskortets MAC-adress till routern och slippa ringa \
    		Internet-leverantören för att ändra den registrerade MAC-adressen gör du så här:";
...
hrouting.phase3="Välj rätt funktionsläge. Behåll standardinställningen <b> \
    		 Gateway</b> om du använder routern som värd för nätverkets Internet-anslutning (gatewayläget rekommenderas för de flesta användare). Välj<b> \
...
hrouting.phase6="Med dynamisk routing kan routern automatiskt justeras för fysiska ändringar i \
    		 nätverkets layout och utbyta routingtabeller med andra routrar. På skärmen \
...
hrouting.phase7="Om du vill aktivera funktionen för dynamisk routing för WAN-sidan väljer du <b>WAN</b>. \
    		 Du kan aktivera den här funktionen för LAN-sidan och den trådlösa sidan genom att välja <b>LAN &amp; trådlöst</b>. \
...
hrouting.phase8="Statisk routing,&nbsp; destinations-IP-adress, nätmask, gateway och gränssnitt";
...
hrouting.phase14="Beroende på var mål-IP-adressen finns väljer du \
     		      		  <b>LAN &amp; trådlöst </b>eller <b>WAN </b>i listrutan <i>Gränssnitt</i>. ";
hrouting.phase15="Du kan spara ändringarna genom att klicka på <b>Verkställ</b>. Du kan avbryta ändringar som inte har sparats genom att klicka på <b>>knappen Avbryt</b>. ";
hrouting.phase16="Upprepa steg 1-4 för fler statiska routrar vid behov.";
hrouting.phase17="Ta bort den\n här posten";
...
hrouting.phase23="Klicka på \
    		  ...
    		  Stäng</b> om du vill återgå till skärmen <i>Routing</i>.";
...
hfirewall.right="Aktivera eller avaktivera SPI-brandväggen.";
...
helpvpn.phase2="Virtual Private Networking (VPN) används vanligen för arbetsrelaterade nätverk. För \
    		VPN-tunnlar finns i routerns funktioner för IPSec- och PPTP-protokoll.";
...
hfilter.phase2="På skärmen <i>Filter</i> kan du blockera eller tillåta vissa typer av Internet-användning \
		. Du kan ange regler för Internet-åtkomst för vissa datorer och konfigurera \
		filter med hjälp av numren på nätverksportarna.";
hfilter.phase3="Med den här funktionen kan du anpassa upp till tio olika regler för Internet-åtkomst \
...
hfilter.phase9="Om du vill blockera de angivna datorerna från Internet under de dagar och den \
    		tid du angett behåller du standardinställningen <b>Avaktivera Internet-åtkomst för angivna \
    		...
    		Internet-åtkomst för angivna datorer</i>.";
...
hfilter.phase11="Ange vilken tid åtkomsten ska filtreras. Välj <b>24 timmar</b> <b>eller</b> markera rutan bredvid <i>Från</i> \
...
hfilter.phase15="Om du vill ta bort en regel för Internet-åtkomst kan du markera regelnumret och klicka på <b>Ta bort</b>.";
...
hfilter.phase18="Du kan filtrera datorer via nätverksportnummer genom att välja <b>Båda</b>, <b>TCP</b> eller <b>UDP</b>, \
    		...
    		routern kommer inte att få åtkomst till de portnummer som anges här längre. Till \
...
helpdmz.phase1="Med DMZ-värdfunktionen kan en lokal användare bli synlig mot Internet för användning \
		...
		Med hjälp av DMZ-värdfunktionen kan alla portar vidarebefordras till en dator samtidigt. Funktionen \
