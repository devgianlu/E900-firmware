...
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:Created>2011-03-18T08:53:00Z</o:Created>
  <o:LastSaved>2011-03-18T08:53:00Z</o:LastSaved>
  <o:Pages>2</o:Pages>
  <o:Words>261</o:Words>
...
document.title="Beveiliging – Firewall";
</script>
<!--[if gte mso 9]><xml>
     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:6;height:18.75pt'>
        ...
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:white'>Help&nbsp;&nbsp;&nbsp;
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        height:.75pt'>
        <h1><span lang=EN-US style='color:#2971B9'>Beveiliging &#8211; Firewall</span><span
        lang=EN-US style='color:black'><o:p></o:p></span></h1>
        <p class=body><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Opmerking: klik nadat u uw wijzigingen hebt
        aangebracht, op <span class=bold>Instellingen opslaan</span> om de
        wijzigingen toe te passen.<o:p></o:p></span></p>
        ...
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><strong>SPI-firewallbeveiliging voor  IPv4/IPv6</strong></p>
        <p>SPI-firewallbeveiliging  helpt uw lokale netwerk te beschermen tegen internetbedreigingen. </p>
        <p class=option><span lang=EN-US style='font-family:Arial;color:black'>Internetfilter</span><span
        ...
        10.0pt;font-family:Arial;color:black'>Anonieme internetverzoeken
        filteren</span></span><span lang=EN-US style='font-size:10.0pt;
        font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=SV style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:SV'>Dit filter houdt internetverzoeken
        vanuit onbekende bronnen tegen, zoals ping-verzoeken.</span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Multicast-filter</span></b><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Dit filter houdt multicasting tegen, waardoor een enkele
        overdracht verschillende ontvangers tegelijk binnen het lokale netwerk
        kan bereiken. <o:p></o:p></span></p>
        <p class=option><strong>NAT-omleiding alleen filteren  voor IPv4-internet</strong></p>
        <p class=option>Dit filter voorkomt dat een lokale computer een URL of een IPv4-adres gebruikt  om toegang te krijgen tot de lokale server.</p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Filter IDENT (poort 113)</span></b><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=SV style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:SV'>Dit filter voorkomt dat poort 113 via
        het internet wordt gescand door apparaten buiten het lokale netwerk. </span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=heading2><span lang=EN-US style='font-size:13.0pt;font-family:
        Arial;color:black'>Webfilter</span><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Proxy</span></b><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=SV style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:SV'>Dit filter blokkeert het gebruik van
        internetproxyservers. </span><span lang=EN-US style='font-size:10.0pt;
        font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Java</span></b><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Dit filter blokkeert Java, zodat u geen toegang meer
        hebt tot Java-inhoud op websites. <o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>ActiveX</span></b><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Dit filter blokkeert ActiveX, zodat u geen toegang
        meer hebt tot ActiveX-inhoud op websites. <o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Cookies</span></b><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Dit filter blokkeert cookies. Cookies zijn kleine
        bestanden die door websites op uw computer worden opgeslagen en worden
        gebruikt wanneer u deze websites bezoekt.<o:p></o:p></span></p>
        <p class=option style='mso-line-height-alt:.75pt'><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'>Opmerking:
        raadpleeg voor meer informatie de online gebruikershandleiding op <b><u><a
       ...
       <tr style='mso-yfti-irow:8;mso-yfti-lastrow:yes;height:33.75pt'>
        ...
        <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
         ...
         <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:
          ...
          text-decoration:none;text-underline:none'>Sluiten</span></a></span></b><span
          lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
          </td>
          ...
          text-decoration:none;text-underline:none'>Afdrukken</span></a></span></b><span
          lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
          </td>
          <td width=10 style='width:7.2pt;padding:0cm 0cm 0cm 0cm;height:11.25pt'>
          <p class=MsoNormal><span lang=EN-US style='font-size:9.0pt;
