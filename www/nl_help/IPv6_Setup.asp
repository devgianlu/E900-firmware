     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        height:.75pt'>
        <h1 class="STYLE1">Instellingen &ndash; Instellingen IPv6 </h1>
        <p>IPv6 is een nieuw IP-protocol dat gebruikmaakt van vereenvoudigde  pakketheaders en dat IPSec vereist voor interoperabiliteit. Het biedt tevens  betere ondersteuning voor mobiele IP-apparaten en computers.<br>
          Opmerking:  klik nadat u uw wijzigingen hebt aangebracht op Instellingen opslaan om de  wijzigingen toe te passen.</p>
        <p><strong>Internetinstellingen</strong></p>
        <p>Type internetverbinding</p>
        <p><strong>IPv6 -  Automatisch</strong></p>
        <p>Selecteer <strong>Ingeschakeld</strong> om automatisch IPv6 te  gebruiken voor alle netwerkadressen.</p>
        <p><strong>DUID</strong></p>
        <p>Dit  is de IPv6 DUID (DHCP for IPv6 Unique Identifier), een waarde die automatisch  door de router wordt gegenereerd.</p>
        <p><strong>Netwerkinstellingen</strong></p>
        <p><strong>6rd-tunnel</strong></p>
        <p>Voor  gebruik van een 6rd-tunnel moet <strong>IPv6 &ndash;  Automatisch</strong> zijn uitgeschakeld. Met een 6rd-tunnel kan de router  IPv6-adressen via een IPv4-netwerk verzenden. Selecteer <strong>Automatische configuratie</strong> als u wilt dat de router de instellingen  (zoals voorvoegsels en adresmaskers) automatisch configureert. Selecteer <strong>Handmatige configuratie</strong> als u deze  instellingen zelf wilt opgeven.</p>
        <p><strong>Voorvoegsel</strong></p>
        <p>Voer  het adresvoorvoegsel in dat wordt gebruikt voor de tunnel die u van uw  internetprovider hebt gekregen.</p>
        <p><strong>Lengte  voorvoegsel</strong></p>
        <p>Voer  de lengte in van het voorvoegsel dat wordt gebruikt voor de tunnel die u van uw  internetprovider hebt gekregen.</p>
        <p><strong>Grens-relay</strong></p>
        <p>Voer  het grens-relay-adres in dat wordt gebruikt voor de tunnel die u van uw  internetprovider hebt gekregen.</p>
        <p><strong>IPv4-adresmasker</strong></p>
        <p>Voer  de lengte in van het IPv4-adresmasker dat wordt gebruikt voor de tunnel die u  van uw internetprovider hebt gekregen.</p>
        <p class=option style='mso-line-height-alt:.75pt'><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'>Opmerking: raadpleeg voor meer informatie de online  gebruikershandleiding op <b><u><a
