	    ...
	    <SELECT onchange=SoryBy(this.form) name=sortby size=1> 
			...
			<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#5b5b5b" id="AutoNumber3" width="509">
              <tr>
                ...
                <span style="font-weight: 700">
                <font face="Arial" style="font-size: 8pt"><script>Capture(stalan.ipv4addr)</script></font></span></td>
...
for(i=0;;i++) {
	...
	if(ret != 1) {
        ...
        document.write("<tr>");
        document.write("<td height=\"25\" width=\"221\" align=\"center\" style=\"border-style:solid; border-width:1; word-break:break-all; word-wrap:break-word; \" bordercolor=\"#2971b9\">");
	...
	if(ret == 1)
		...
		document.write("<INPUT  style=\"FONT-SIZE: 8pt; font-family:Arial\" type=button value='"+sbutton.del+"' onclick=to_delete("+ip[3]+")></b></font></td>");
        document.write("</tr>");
