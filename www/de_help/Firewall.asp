...
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:Created>2011-03-18T08:44:00Z</o:Created>
  <o:LastSaved>2011-03-18T08:44:00Z</o:LastSaved>
  <o:Pages>2</o:Pages>
  <o:Words>271</o:Words>
  <o:Characters>1548</o:Characters>
  <o:Company>bbb</o:Company>
  <o:Lines>12</o:Lines>
  <o:Paragraphs>3</o:Paragraphs>
  <o:CharactersWithSpaces>1816</o:CharactersWithSpaces>
...
document.title="Sicherheit – Firewall";
</script>
<!--[if gte mso 9]><xml>
     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:6;height:18.75pt'>
        ...
        Arial;color:white'>Hilfe</span></b></span><b><span lang=EN-US
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        height:.75pt'>
        <h1><span lang=DE style='color:#2971B9;mso-ansi-language:DE'>Sicherheit
        &#8211; Firewall</span><span lang=EN-US style='color:black'><o:p></o:p></span></h1>
        <p class=body><span lang=DE style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:DE'>Hinweis: Nachdem Sie Ihre Änderungen durchgeführt
        haben, klicken Sie auf <span class=bold>Einstellungen speichern</span>,
        um die Änderungen zu übernehmen.</span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=heading2><span lang=DE style='font-size:13.0pt;font-family:
        Arial;color:black;mso-ansi-language:DE'>Firewall</span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><strong>IPv4/IPv6 SPI Firewall-Schutz</strong><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option>Der SPI-Firewall-Schutz hilft dabei, Ihr lokales Netzwerk vor Angriffen  aus dem Internet zu sch&uuml;tzen.<span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=heading3><span lang=DE style='font-family:Arial;color:black;
        mso-ansi-language:DE'>Internet-Filter</span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span class=bold><span lang=DE style='font-size:10.0pt;
        font-family:Arial;color:black;mso-ansi-language:DE'>Anonyme Internetanfragen
        filtern</span></span><span lang=EN-US style='font-size:10.0pt;
        font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=DE style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:DE'>Dieser Filter blockiert
        Internetanfragen von unbekannten Quellen, beispielsweise Ping-Anfragen.</span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=DE style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:DE'>Multicast filtern</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=DE style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:DE'>Dieser Filter blockiert
        Multicast-Übertragungen, die eine einzelne Übertragung gleichzeitig an
        spezifische Empfänger in Ihrem lokalen Netzwerk ermöglichen. </span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><strong>Internet-NAT-Umleitung nur  nach IPv4-Internet filtern</strong></p>
        <p class=option>Dieser Filter verhindert, dass ein lokaler Computer &uuml;ber eine URL oder  eine Internet-IPv4-Adresse auf den lokalen Server zugreift.<span lang=EN-US style='font-size:10.0pt;
        font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=DE style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:DE'>IDENT (Port 113) filtern</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=DE style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:DE'>Mit diesem Filter wird verhindert,
        dass der Port&nbsp;113 von Geräten aus dem Internet abgefragt wird. </span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=heading2><span lang=DE style='font-size:13.0pt;font-family:
        Arial;color:black;mso-ansi-language:DE'>Web-Filter</span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=DE style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:DE'>Proxy</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=DE style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:DE'>Dieser Filter blockiert die
        Verwendung von Internet-Proxy-Servern. </span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=DE style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:DE'>Java</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=DE style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:DE'>Dieser Filter blockiert Java. Sie
        können also möglicherweise nicht auf Java-Inhalte auf Websites zugreifen.
        </span><span lang=EN-US style='font-size:10.0pt;font-family:Arial;
        color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=DE style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:DE'>ActiveX</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=DE style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:DE'>Dieser Filter blockiert ActiveX. Sie
        können also möglicherweise nicht auf ActiveX-Inhalte auf Websites
        zugreifen. </span><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=DE style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:DE'>Cookies</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=DE style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:DE'>Dieser Filter blockiert Cookies.
        Cookies sind Daten, die auf Ihrem Computer gespeichert und von Websites
        beim Zugriff auf diese Sites verwendet werden.</span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option style='mso-line-height-alt:.75pt'><span lang=DE
        style='font-size:10.0pt;font-family:Arial;color:black;mso-ansi-language:
        DE'>Hinweis: Weitere Informationen erhalten Sie im Online-Guide unter <b><u><a
        href="http://www.linksys.com">www.linksys.com<span style='font-weight:
        normal'>.</span></a></u></b></span><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        </td>
       ...
       <tr style='mso-yfti-irow:8;mso-yfti-lastrow:yes;height:33.75pt'>
        ...
        <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
         ...
         <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:
          ...
          text-decoration:none;text-underline:none'>Schließen</span></a></span></b><span
          lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
          </td>
          ...
          text-decoration:none;text-underline:none'>Drucken</span></a></span></b><span
          lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
          </td>
          <td width=10 style='width:7.2pt;padding:0cm 0cm 0cm 0cm;height:11.25pt'>
          <p class=MsoNormal><span lang=EN-US style='font-size:9.0pt;
