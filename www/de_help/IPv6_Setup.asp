...
<![endif]-->
<TITLE>Einrichtung von IPv6</TITLE>
     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:6;height:18.75pt'>
        ...
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:white'>Hilfe&nbsp;&nbsp;&nbsp;
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        height:.75pt'>
        <h1><span lang=EN-US style='font-size:16.0pt;color:#2971B9'>Einrichtung&nbsp;&ndash; Einrichtung von IPv6</span></h1>
        <p>IPv6  ist ein neues IP-Protokoll, das vereinfachte Paket-Kopfzeilen nutzt und zur  Interoperabilit&auml;t IPSec ben&ouml;tigt. Es bietet verbesserte Unterst&uuml;tzung f&uuml;r  mobile IP-Ger&auml;te und Computer.<br>
          Hinweis:  Nachdem Sie Ihre &Auml;nderungen durchgef&uuml;hrt haben, klicken Sie auf Save Settings (Einstellungen  speichern) um die &Auml;nderungen zu &uuml;bernehmen.</p>
        <p><strong>Internet-Einrichtung</strong></p>
        <p>Internetverbindungstyp</p>
        <p><strong>IPv6 -  Automatic (IPv6 &ndash; automatisch)</strong></p>
        <p>W&auml;hlen  Sie <strong>Enabled (Aktiviert)</strong>, um IPv6  automatisch f&uuml;r alle Netzwerkverbindungen zu nutzen.</p>
        <p><strong>DUID</strong></p>
        <p>Dies  ist der IPv6 DUID (DHCP f&uuml;r IPv6 Unique Identifier) Wert, den der Router  automatisch erstellt.</p>
        <p><strong>Netzwerkeinrichtung</strong></p>
        <p><strong>6. Tunnel</strong></p>
        <p>Um  den 6. Tunnel zu nutzen, muss <strong>IPv6 -  Automatic (IPv6 &ndash; automatisch)</strong> deaktiviert sein. Der 6. Tunnel erm&ouml;glicht  es Ihrem Router, IPv6 IP-Adressen &uuml;ber IPv4-Netzwerke zu senden. W&auml;hlen Sie <strong>Automatic Configuration (Automatische  Konfiguration)</strong>, damit Ihr Router die Einstellungen (z.&nbsp;B. Pr&auml;fixe und  Adressmasken) automatisch vornimmt. W&auml;hlen Sie <strong>Manual Configuration (Manuelle Konfiguration)</strong>, um die &Auml;nderungen  manuell vorzunehmen.</p>
        <p><strong>Pr&auml;fix</strong></p>
        <p>Geben  Sie die Pr&auml;fix-Adresse f&uuml;r den von Ihrem ISP bereitgestellten Tunnel ein.</p>
        <p><strong>Pr&auml;fixl&auml;nge</strong></p>
        <p>Geben  Sie die Pr&auml;fixl&auml;nge f&uuml;r den von Ihrem ISP bereitgestellten Tunnel ein.</p>
        <p><strong>Rahmen-Relay</strong></p>
        <p>Geben  Sie das Rahmen-Relay f&uuml;r den von Ihrem ISP bereitgestellten Tunnel ein.</p>
        <p><strong>IPv4-Adressmaske</strong></p>
        <p>Geben  Sie die IPv4-Adressmaske f&uuml;r den von Ihrem ISP bereitgestellten Tunnel ein.</p>
        <p class=option style='mso-line-height-alt:.75pt'><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'>Hinweis:  Weitere Informationen erhalten Sie im Online-Guide unter <b><u><a
