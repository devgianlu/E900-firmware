...
<HTML <% ui_position("dir", ""); %>><HEAD><TITLE>PC Warning</TITLE>
<% no_cache(); %>
<% charset(); %>
...
<CENTER>
<TABLE borderColor=#5b5b5b height=268 cellSpacing=0 cellPadding=0 width=602 bgColor=#ffffff border=0>
  <TBODY>
  <TR>
    <TH width=602 colSpan=2 height=268 bordercolor="#FFFFFF">
        ...
        <TR>
          <TH width=602 height=268>
            <TABLE cellSpacing=0 width=602 bgColor=#ffffff 
              border=0 style="border-collapse: collapse" bordercolor="#5b5b5b" cellpadding="0" height="265"><TBODY>
              <TR>
                <TH vAlign=bottom align=right width=602 bgColor=#FFFFFF height="265">
                <div align="left" style="width: 602px; height: 270px">
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#5b5b5b" id="AutoNumber1" width="602" height="269">
                    <tr>
			...
			<table>
			  <tr>
				...
				<td width = "38" height="20"><img border="0" src="image/alert_minor.gif"></td>
                      ...
                      <td   width="400" height="20"><font face="Arial" style="font-size: 8pt"><b><script>Capture(pctrl.pcarinfo3)</script>:</b></font>
			<script>
			if( "<% nvram_get("tmsss_enabled");%>" == "1")
				...
				document.write("<font face='Arial' color=red style='font-size: 8pt'><b>" + share.disabled + "</b></font>");
                    ...
                    <tr>
                      ...
                      <td   width="400" height="20"><font face="Arial" style="font-size: 8pt"><b><script>Capture(pctrl.pcarinfo4)</script></b></font></td>
                      <td height="20" width="14" bgcolor="#FFFFFF"></td>
                      </tr>
                      <tr>
                    	<td   width="145" height="20" bgcolor="#E7E7E7"></td>
                    ...
                    <tr>
                      <td height="51" width="145" bgcolor="#E7E7E7" style="border-top-style: none; border-top-width: medium"></td>
                      <td height="51" width="43" bgcolor="#FFFFFF"></td>
                      <td height="51" width="414" bgcolor="#FFFFFF" colspan="3">
