        ...
        <TD class=FUNFIELD>&nbsp;<INPUT style="width:40px" name=wl0_radius_port value='<% get_web_valueex("wl0_radius_port"); %>' maxlength=5 onBlur=valid_range(this,1,65535,"Port")></TD></TR>
		<TR><script>draw_table(SUBFUN,"");</script>
