...
<TABLE cellSpacing=0 cellPadding=10 width=873 border=1>
  <TBODY>
	<BR></BR>
 <TR>
    <TD colSpan=6 height=30><B><FONT face=Arial color=#0000ff><SPAN STYLE="FONT-SIZE:14pt">ip6tables ¨Cn ¨CL</SPAN></FONT></B></TD>
  <TR align=middle bgColor=#b3b3b3>	
  <TR>	
  <TR>
    <TD width=812>
...
<P> <INPUT type=button value=" Refresh " onClick=window.location.replace("CBT_SystemIp6tables.asp")></P></CENTER>
</FORM>
</BODY>
</HTML>
