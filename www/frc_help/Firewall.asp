...
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:Created>2011-03-18T08:47:00Z</o:Created>
  <o:LastSaved>2011-03-18T08:48:00Z</o:LastSaved>
  <o:Pages>2</o:Pages>
  <o:Words>261</o:Words>
...
document.title="Sécurité – Pare-feu";
</script>
<!--[if gte mso 9]><xml>
     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:6;height:18.75pt'>
        ...
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:white'>Aide&nbsp;&nbsp;&nbsp;
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        height:.75pt'>
        <h1><span lang=ES-MX style='color:#2971B9;mso-ansi-language:ES-MX'>Sécurité&nbsp;&#8211;
        Pare-feu</span><span lang=EN-US style='color:black'><o:p></o:p></span></h1>
        <p class=body><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Remarque&nbsp;: après avoir
        entré les modifications, cliquez sur <span class=bold>Enregistrer les
        paramètres</span> pour les appliquer.</span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=heading2><span lang=ES-MX style='font-size:13.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Pare-feu</span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><strong>Protection de pare-feu&nbsp;SPI IPv4/IPv6</strong></p>
        <p class=option>La  protection de pare-feu&nbsp;SPI prot&egrave;ge votre r&eacute;seau local des menaces  Internet.<span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=heading3><span lang=FR-BE style='font-family:Arial;color:black;
        mso-ansi-language:FR-BE'>Filtre Internet</span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span class=bold><span lang=FR-BE style='font-size:
        10.0pt;font-family:Arial;color:black;mso-ansi-language:FR-BE'>Filtrer
        les requêtes Internet anonymes</span></span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Ce filtre bloque les
        requêtes Internet provenant de sources inconnues, par exemple, les
        requêtes ping.</span><span lang=EN-US style='font-size:10.0pt;
        font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Filtre multidiffusion</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Ce filtre bloque la multidiffusion,
        qui se produit lorsqu'une transmission unique atteint plusieurs
        destinataires spécifiques en même temps sur votre réseau local. </span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><strong>Filtre de redirection NAT Internet pour  Internet&nbsp;IPv4 uniquement</strong></p>
        <p class=option>Ce  filtre interdit &agrave; votre ordinateur local d'utiliser une adresse Internet ou une  adresse Internet IPv4 pour acc&eacute;der au serveur local.</p>
        <p class=option><b><span lang=FR-BE style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:FR-BE'>Filtre IDENT (Port&nbsp;113)</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=FR-BE style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:FR-BE'>Cette option empêche les
        machines situées sur Internet d'accéder au port&nbsp;113. </span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=heading2><span lang=FR-BE style='font-family:Arial;color:black;
        mso-ansi-language:FR-BE'>Filtre Web</span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=FR-BE style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:FR-BE'>Proxy</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=FR-BE style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:FR-BE'>Cette option empêche
        l'utilisation de serveurs proxy. </span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=FR-BE style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:FR-BE'>Java</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Cette option bloque Java, ce
        qui vous empêche d'accéder à du contenu Java sur les sites Web. </span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>ActiveX</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Cette option bloque les
        composants ActiveX, ce qui vous empêche d'accéder à du contenu ActiveX
        sur les sites Web. </span><span lang=EN-US style='font-size:10.0pt;
        font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=FR-BE style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:FR-BE'>Cookies</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=FR-BE style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:FR-BE'>Cette option bloque les
        cookies. </span><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Un cookie est un fichier
        enregistré sur votre ordinateur par les sites Internet que vous
        visitez.</span><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'><o:p></o:p></span></p>
        <p class=option style='mso-line-height-alt:.75pt'><span lang=ES-MX
        style='font-size:10.0pt;font-family:Arial;color:black;mso-ansi-language:
        ES-MX'>Remarque&nbsp;: pour en savoir plus, reportez-vous au Guide de
        l'utilisateur en ligne à <b><u><a href="http://www.linksys.com">www.linksys.com<span
       ...
       <tr style='mso-yfti-irow:8;mso-yfti-lastrow:yes;height:33.75pt'>
        ...
        <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
         ...
         <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:
          ...
          text-decoration:none;text-underline:none'>Fermer</span></a></span></b><span
          lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
          </td>
          ...
          text-decoration:none;text-underline:none'>Imprimer</span></a></span></b><span
          lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
          </td>
          <td width=10 style='width:7.2pt;padding:0cm 0cm 0cm 0cm;height:11.25pt'>
          <p class=MsoNormal><span lang=EN-US style='font-size:9.0pt;
