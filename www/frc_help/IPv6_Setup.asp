     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:12.0pt'>
        ...
        style='font-size:10.0pt;font-family:Arial;color:black'>&nbsp;<o:p></o:p></span></p>        </td>
       ...
       <tr style='mso-yfti-irow:2;height:42.75pt'>
        ...
        style="margin-left: 25; margin-top: 10" id="_x0000_i1026" src="Setup/linksys_logo.png" border=0><o:p></o:p></span></p>        </td>
       </tr>
       ...
       <tr style='mso-yfti-irow:4;height:11.25pt'>
        ...
        Arial;color:black'><o:p>&nbsp;</o:p></span></p>        </td>
       ...
       <tr style='mso-yfti-irow:5;height:5.25pt'>
        ...
        10.0pt;font-family:Arial;color:black'><o:p>&nbsp;</o:p></span></p>        </td>
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'>&nbsp;<o:p></o:p></span></p>        </td>
        <td width=564 style='width:423.0pt;background:white;padding:0cm 0cm 0cm 0cm;
        height:.75pt'>
        <h1 class="STYLE1">Configuration  &ndash; IPv6</h1>
        <p>IPv6  est un nouveau protocole IP qui utilise des en-t&ecirc;tes de paquet simplifi&eacute;s et  qui a absolument besoin d'IPSec en mati&egrave;re d'interop&eacute;rabilit&eacute;. Il a &eacute;galement  am&eacute;lior&eacute; le soutien de l'IP mobile et des dispositifs de calcul.<br>
          Remarque&nbsp;:  Apr&egrave;s avoir effectu&eacute; vos modifications, cliquez sur Enregistrer les param&egrave;tres pour  appliquer vos changements.</p>
        <p><strong>Configuration Internet</strong></p>
        <p>Type de connexion Internet</p>
        <p><strong>IPv6 -  Automatique</strong></p>
        <p>S&eacute;lectionnez <strong>Activ&eacute;</strong> pour utiliser automatiquement  IPv6 pour tous les adressages r&eacute;seau.</p>
        <p><strong>DUID</strong></p>
        <p>Il  s'agit de la valeur IPv6 DUID (DHCP pour identifiant unique IPv6) que le  routeur g&eacute;n&egrave;re automatiquement.</p>
        <p><strong>Configuration du r&eacute;seau</strong></p>
        <p><strong>Tunnel&nbsp;6rd</strong></p>
        <p>Pour  utiliser le tunnel&nbsp;6rd, <strong>IPv6 &ndash;  Automatique</strong> doit &ecirc;tre activ&eacute;. Un tunnel&nbsp;6rd permet &agrave; votre routeur  d'envoyer des adresses IP IPv6 dans les r&eacute;seaux IPv4. S&eacute;lectionnez <strong>Configuration automatique</strong> pour que  votre routeur g&egrave;re automatiquement ces param&egrave;tres (tels que les pr&eacute;fixes et les  masques de sous-r&eacute;seau). S&eacute;lectionnez <strong>Configuration  manuelle</strong> pour modifier ces param&egrave;tres manuellement.</p>
        <p><strong>Pr&eacute;fixe</strong></p>
        <p>Entrez  l'adresse du pr&eacute;fixe utilis&eacute; par le tunnel fourni par votre FAI.</p>
        <p><strong>Longueur du  pr&eacute;fixe</strong></p>
        <p>Entrez  la longueur du pr&eacute;fixe utilis&eacute; par le tunnel fourni par votre FAI.</p>
        <p><strong>Relais&nbsp;&ndash;  Fronti&egrave;re</strong></p>
        <p>Entrez  l'adresse du relais-fronti&egrave;re utilis&eacute; par le tunnel fourni par votre FAI.</p>
        <p><strong>Masque de  sous-r&eacute;seau&nbsp;IPv4</strong></p>
        <p>Entrez  la longueur du masque de sous-r&eacute;seau IPv4 utilis&eacute; par le tunnel fourni par  votre FAI.</p>
        <p class=option style='mso-line-height-alt:.75pt'><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'>Remarque&nbsp;:  pour en savoir plus, reportez-vous au Guide de l'utilisateur en ligne &agrave; <b><u><a
        href="http://www.linksys.com">www.linksys.com<span style='font-weight:
        normal'>.</span></a></u></b><o:p></o:p></span></p>        </td>
       ...
       <tr style='mso-yfti-irow:8;mso-yfti-lastrow:yes;height:33.75pt'>
        ...
        <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
         ...
         <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:
          ...
          mso-bidi-font-size:10.0pt;font-family:Arial;color:black'><o:p>&nbsp;</o:p></span></p>          </td>
