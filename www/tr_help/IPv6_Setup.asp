     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        height:.75pt'>
        <h1><span lang=EN-US style='font-size:16.0pt;color:#2971B9'>Ayarlar &ndash; IPv6 Ayarlarý</span></h1>
        <p>IPv6 basitleþtirilmiþ paket baþlýklarýný kullanan yeni bir IP protokolüdür ve temel bir birlikte çalýþma þartý olarak IPSec gerektirir. Mobil IP ve bilgi iþlem aygýtlarý için de daha fazla destek sunar.<br>
          Not: Deðiþikliklerinizi yaptýktan sonra, deðiþikliklerinizi uygulamak için Ayarlarý Kaydet düðmesine týklayýn.</p>
        <p><strong>Ýnternet Ayarlarý</strong></p>
        <p>Internet Baðlantý Türü</p>
        <strong>IPv6 - Otomatik</strong>
        <p>Tüm að adreslemeleri için otomatik olarak IPv6 kullanmak için <strong>Etkin</strong> ayarýný seçin.</p>
        <p><strong>DUID</strong></p>
        <p>Bu, router'ýn otomatik olarak ürettiði IPv6 DUID (DHCP for IPv6 Unique Identifier) deðeridir.</p>
        <p><strong>Að Ayarlarý</strong></p>
        <p><strong>6rd Tüneli</strong></p>
        6rd Tünelini kullanmak için, <strong>IPv6 &ndash; Otomatik</strong> ayarý devreden çýkarýlmalýdýr. Bir 6rd Tüneli router'ýnýzýn IPv4 aðlarý aracýlýðýyla IPv6 IP adresleri göndermesini saðlar. Router'ýnýzýn bu ayarlarý (örneðin önekleri ve adres maskelerini) otomatik olarak yönetmesi için <strong>Otomatik Yapýlandýrma</strong> ayarýný seçin. Bu ayarlarý elle deðiþtirmek için, <strong>Elle Yapýlandýrma</strong> ayarýný seçin.
        <p><strong>Önek</strong></p>
        <p>ÝSS'nýz tarafýndan tünel için kullanýlan önek adresini girin.</p>
        <p><strong>Önek Uzunluðu</strong></p>
        <p>ÝSS'nýz tarafýndan tünel için kullanýlan önek uzunluðunu girin.</p>
        <p><strong>Sýnýr Rölesi</strong></p>
        <p>ÝSS'nýz tarafýndan tünel için kullanýlan sýnýr rölesini girin.</p>
        <p><strong>IPv4 Adres Maskesi</strong></p>
        <p>ÝSS'nýz tarafýndan tünel için kullanýlan IPv4 adresini girin.</p>
