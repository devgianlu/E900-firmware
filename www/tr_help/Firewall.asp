     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:6;height:18.75pt'>
        ...
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:white'>Yardým&nbsp;&nbsp;&nbsp;
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        height:.75pt'>
        <h1><span lang=EN-US style='font-size:16.0pt;color:#2971B9'>Güvenlik &#8211; Güvenlik Duvarý</span><span lang=EN-US style='color:black'><o:p></o:p></span></h1>
        <p class=body><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Not: Deðiþikliklerinizi yaptýktan sonra, deðiþikliklerinizi uygulamak için <span
        class=bold>Ayarlarý Kaydet</span> düðmesine týklayýn.<o:p></o:p></span></p>
        <p class=heading2><span style='font-size:13.0pt;font-family:
        Arial;color:black' lang=EN-US><strong>Güvenlik Duvarý</strong></span><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><strong>IPv4/IPv6 SPI Güvenlik Duvarý Korumasý</strong><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>SPI güvenlik duvarý korumasý yerel aðýnýzý Ýnternet tehditlerinden korur.
          <o:p></o:p></span></p>
        <p class=heading3 STYLE1><span lang=EN-US style='font-family:Arial;color:black'>Ýnternet Filtresi</span><span lang=EN-US style='font-size:10.0pt;font-family:Arial;
        color:black'><o:p></o:p></span></p>
        <p class=option><span class=bold><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'>Anonim Ýnternet Ýsteklerini Filtrele</span></span><span lang=EN-US style='font-size:10.0pt;
        font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Bu ping istekleri gibi bilinmeyen kaynaklardan gelen Ýnternet isteklerini engeller.<o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Çoklu Yayýnlarý Filtrele</span></b><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Bu filtre tek bir aktarýmýn yerel aðýnýzdaki spesifik alýcýlara eþzamanlý olarak iletilmesini saðlayan çoklu yayýnlarý engeller. <o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'><strong>Ýnternet NAT Yeniden Yönlendirmesini Yalnýzca IPv4 Ýçin Filtrele</strong>
          <o:p></o:p></span></b></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Bu filtre yerel bir bilgisayarýn yerel sunucuya eriþmek için bir URL veya Ýnternet IPv4 adresini kullanmasýný önler.
<o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>IDENT Filtresi (Port 113)</span></b><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Bu filtre 113 portunun Ýnternet'ten aygýtlar tarafýndan taranmasýný engeller. <o:p></o:p></span></p>
        <p class=heading2><span lang=EN-US style='font-size:13.0pt;font-family:
        Arial;color:black'>Web Filtresi</span><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Proxy</span></b><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Bu filtre Internet proxy sunucularýný engeller. <o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Java</span></b><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Bu filtre Java'yý engeller, bu nedenle web sitelerindeki Java içeriklerine eriþemeyebilirsiniz. <o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>ActiveX</span></b><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Bu filtre ActiveX'i engeller, bu nedenle web sitelerindeki ActiveX içeriklerine eriþemeyebilirsiniz. <o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Çerezler</span></b><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Bu filtre, bilgisayarýnýzda saklanan ve etkinleþtirdiðiniz web siteleri tarafýndan kullanýlan çerezleri engeller.<o:p></o:p></span></p>
        <p class=option style='mso-line-height-alt:.75pt'><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'>Not: Daha fazla bilgi için, <b><u><a
        href="http://www.linksys.com">www.linksys.com</a></u></b><o:p></o:p> adresinde çevrimiçi Kullanýcý Kýlavuzuna bakýn<span style='font-weight:
        normal'>.</span></span></p>
        </td>
       ...
       <tr style='mso-yfti-irow:8;mso-yfti-lastrow:yes;height:33.75pt'>
        ...
        <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
         ...
         <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:
          ...
          text-decoration:none;text-underline:none'>Yazdýr</span></a></span></b><span
          lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
          </td>
          <td width=10 style='width:7.2pt;padding:0cm 0cm 0cm 0cm;height:11.25pt'>
          <p class=MsoNormal><span lang=EN-US style='font-size:9.0pt;
