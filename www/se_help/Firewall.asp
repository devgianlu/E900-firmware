...
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:Created>2011-03-18T08:55:00Z</o:Created>
...
document.title="Säkerhet – Brandvägg";
</script>
<!--[if gte mso 9]><xml>
     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:6;height:18.75pt'>
        ...
        Arial;color:white'>Hjälp</span></b></span><b><span lang=EN-US
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        height:.75pt'>
        <h1><span lang=SV style='color:#2971B9;mso-ansi-language:SV'>Säkerhet
        &#8211; Brandvägg</span><span lang=EN-US style='color:black'><o:p></o:p></span></h1>
        <p class=body><span lang=SV style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:SV'>Obs! När du har gjort dina ändringar
        klickar du på <span class=bold>Spara inställningar</span> för att
        tillämpa ändringarna.</span><span lang=EN-US style='font-size:10.0pt;
        font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=heading2><span lang=SV style='font-size:13.0pt;font-family:
        Arial;color:black;mso-ansi-language:SV'>Brandvägg</span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><strong>IPv4/IPv6-SPI-brandv&auml;ggsskydd</strong></p>
        <p>Med SPI-brandv&auml;ggsskydd  hj&auml;lper du till att skydda ditt lokala n&auml;tverk gentemot internet-hot. </p>
        <p class=option><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span><span lang=SV style='font-family:Arial;color:black;
        mso-ansi-language:SV'>Internetfilter</span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'>
          <o:p></o:p>
        </span></p>
        <p class=option><span class=bold><span lang=SV style='font-size:10.0pt;
        font-family:Arial;color:black;mso-ansi-language:SV'>Filtrera anonyma
        internetbegäran</span></span><span lang=EN-US style='font-size:10.0pt;
        font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=SV style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:SV'>Med det här filtret blockeras
        internetbegäran från okända källor, exempelvis pingbegäran.</span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=SV style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:SV'>Filtrera multicast</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=SV style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:SV'>Med det här filtret blockerar du multicasting,
        där en enskild överföring kan nå olika mottagare i det lokala nätverket
        samtidigt. </span><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'><o:p></o:p></span></p>
        <p class=option><strong>Filtrera NAT-omdirigeringar  via internet endast f&ouml;r IPv4-internet</strong></p>
        <p class=option>Med det h&auml;r filtret f&ouml;rhindrar du att en lokal dator anv&auml;nder en  URL-adress eller internet-IPv4-adress f&ouml;r &aring;tkomst till den lokala servern.</p>
        <p class=option><b><span lang=SV style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:SV'>Filtrera IDENT (Port 113)</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=SV style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:SV'>Med det här filtret förhindrar du att
        port 113 söks av från enheter på internet. </span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=heading2><span lang=SV style='font-size:13.0pt;font-family:
        Arial;color:black;mso-ansi-language:SV'>Webbfilter</span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=SV style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:SV'>Proxy</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=SV style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:SV'>Med det här filtret blockerar du
        användningen av proxyservrar på internet. </span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=SV style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:SV'>Java</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=SV style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:SV'>Med det här filtret blockerar du
        Java, så du kanske inte kommer kunna använda Java-innehåll på
        webbplatser. </span><span lang=EN-US style='font-size:10.0pt;
        font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=SV style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:SV'>ActiveX</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=SV style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:SV'>Med det här filtret blockerar du
        ActiveX, så du kanske inte kommer kunna använda ActiveX-innehåll på
        webbplatser. </span><span lang=EN-US style='font-size:10.0pt;
        font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=SV style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:SV'>Cookies</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=SV style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:SV'>Med det här filtret blockerar du
        användningen av cookie-filer, som lagrar information på din dator och
        används av webbplatser när du interagerar med dem.</span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option style='mso-line-height-alt:.75pt'><span lang=SV
        style='font-size:10.0pt;font-family:Arial;color:black;mso-ansi-language:
        SV'>Obs! Mer information finns i användarhandboken online på adressen <b><u><a
       ...
       <tr style='mso-yfti-irow:8;mso-yfti-lastrow:yes;height:33.75pt'>
        ...
        <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
         ...
         <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:
          ...
          text-decoration:none;text-underline:none'>Stäng</span></a></span></b><span
          lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
          </td>
          ...
          text-decoration:none;text-underline:none'>Skriv ut</span></a></span></b><span
          lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
          </td>
          <td width=10 style='width:7.2pt;padding:0cm 0cm 0cm 0cm;height:11.25pt'>
          <p class=MsoNormal><span lang=EN-US style='font-size:9.0pt;
