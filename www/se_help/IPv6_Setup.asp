     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:6;height:18.75pt'>
        ...
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:white'>Hjälp&nbsp;&nbsp;&nbsp;
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        <p>IPv6  &auml;r ett nytt IP-protokoll som anv&auml;nder f&ouml;renklade pakethuvuden och IPSec &auml;r ett  grundl&auml;ggande krav f&ouml;r interoperabilitet. F&ouml;rb&auml;ttrade funktioner f&ouml;r mobila  IP-adresser och datorenheter.<br>
          Obs!  N&auml;r du har gjort dina &auml;ndringar klickar du p&aring; Spara inst&auml;llningar s&aring;  verkst&auml;lls &auml;ndringarna.</p>
        <p><strong>Internetinst&auml;llningar</strong></p>
        <p>Internetanslutningstyp</p>
        <p><strong>IPv6 &ndash;  automatisk</strong></p>
        <p>V&auml;lj <strong>Aktiverad</strong> s&aring; anv&auml;nds IPv6  automatiskt f&ouml;r alla n&auml;tverksadresseringar.</p>
        <p><strong>DUID</strong></p>
        <p>Det  h&auml;r &auml;r DUID-v&auml;rdet f&ouml;r IPv6 (DHCP som &auml;r ett unikt ID f&ouml;r IPv6) som routern  automatiskt skapar.</p>
        <p><strong>N&auml;tverksinst&auml;llningar</strong></p>
        <p><strong>6rd-tunnel</strong></p>
        <p>N&auml;r  6rd-tunneln ska anv&auml;ndas m&aring;ste <strong>IPv6 &ndash;  automatiskt</strong> var avaktiverat. Med en 6rd-tunnel kan routern skicka IPv6  IP-adresser via IPv4-n&auml;tverk. V&auml;lj <strong>Automatisk  konfiguration</strong> f&ouml;r routern s&aring; hanteras de h&auml;r inst&auml;llningarna (som prefix  och adressmasker) automatiskt. V&auml;lj <strong>Manuell  konfiguration</strong> om du vill &auml;ndra de h&auml;r inst&auml;llningarna manuellt.</p>
        <p><strong>Prefix</strong></p>
        <p>Ange prefixadressen som anv&auml;nds f&ouml;r tunneln som du har f&aring;tt av  internetleverant&ouml;ren.</p>
        <p><strong>Prefixl&auml;ngd</strong></p>
        <p>Ange  prefixl&auml;ngden f&ouml;r tunneln som du har f&aring;tt av internetleverant&ouml;ren.</p>
        <p><strong>Gr&auml;nsrel&auml;</strong></p>
        <p>Ange  gr&auml;nsrel&auml;adressen f&ouml;r tunneln som du har f&aring;tt av internetleverant&ouml;ren.</p>
        <p><strong>IPv4-adressmask</strong></p>
        <p>Ange  IPv4-adressmaskl&auml;ngden f&ouml;r tunneln som du har f&aring;tt av internetleverant&ouml;ren.</p>
        <p class=option style='mso-line-height-alt:.75pt'><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'>Obs! Mer  information finns i anv&auml;ndarhandboken online p&aring; adressen <b><u><a
