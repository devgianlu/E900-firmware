     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        height:.75pt'>
        <h1><span lang=EN-US style='font-size:16.0pt;color:#2971B9'>Zabezpieczenia — Zapora</span><span lang=EN-US style='color:black'><o:p></o:p></span></h1>
        <p class=body><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Uwaga: po dokonaniu zmian kliknij przycisk <span
        class=bold>Zapisz ustawienia</span>, aby je zastosować.<o:p></o:p></span></p>
        <p class=heading2><span style='font-size:13.0pt;font-family:
        Arial;color:black' lang=EN-US><strong>Zapora</strong></span><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><strong>Ochrona przez zaporę IPv4/IPv6 SPI</strong><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Zapora SPI pomaga chronić sieć lokalną przed zagrożeniami z Internetu.
          <o:p></o:p></span></p>
        <p class=heading3 STYLE1><span lang=EN-US style='font-family:Arial;color:black'>Filtr internetowy</span><span lang=EN-US style='font-size:10.0pt;font-family:Arial;
        color:black'><o:p></o:p></span></p>
        <p class=option><span class=bold><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'>Filtruj anonimowe żądania dotyczące Internetu</span></span><span lang=EN-US style='font-size:10.0pt;
        font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Ten filtr blokuje żądania internetowe z nieznanych źródeł, takie jak żądania pingowania.<o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Filtruj komunikaty typu multicast</span></b><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Ten filtr blokuje multicasting, który umożliwia jednoczesne dotarcie pojedynczej transmisji do poszczególnych odbiorców w sieci lokalnej. <o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'><strong>Filtruj przekierowania internetowe NAT tylko dla IPv4</strong>
          <o:p></o:p></span></b></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Ten filtr uniemożliwia komputerowi lokalnemu użycie adresu URL lub internetowego adresu IPv4 w celu uzyskania dostępu do serwera lokalnego.
<o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Filtruj protokół IDENT (port 113)</span></b><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Ten filtr uniemożliwia skanowanie portu 113 przez urządzenia w Internecie. <o:p></o:p></span></p>
        <p class=heading2><span lang=EN-US style='font-size:13.0pt;font-family:
        Arial;color:black'>Filtr sieciowy</span><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Proxy</span></b><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Ten filtr blokuje użycie internetowych serwerów proxy. <o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Java</span></b><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Ten filtr blokuje język Java, przez co nie będzie możliwe uzyskanie dostępu do zawartości Java w witrynach internetowych. <o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>ActiveX</span></b><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Ten filtr blokuje skrypty ActiveX, przez co nie będzie możliwe uzyskanie dostępu do zawartości ActiveX w witrynach internetowych. <o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Pliki cookie</span></b><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Ten filtr blokuje pliki cookie zawierające dane przechowywane na komputerze użytkownika i wykorzystywane przez witryny internetowe podczas ich przeglądania.<o:p></o:p></span></p>
        <p class=option style='mso-line-height-alt:.75pt'><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'>Uwaga: Aby uzyskać więcej informacji, zapoznaj się z Podręcznikiem użytkownika online pod adresem <b><u><a
