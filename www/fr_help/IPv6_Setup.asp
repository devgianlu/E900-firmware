     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        height:.75pt'>
        <h1 class="STYLE1">Configuration &ndash; Configuration IPv6</h1>
        <p>IPv6  est un nouveau protocole IP qui utilise des en-t&ecirc;tes de paquet simplifi&eacute;s et  qui exige IPSec pour des raisons d'interop&eacute;rabilit&eacute;. Il offre &eacute;galement une  meilleure prise en charge des IP mobiles et des p&eacute;riph&eacute;riques informatiques.<br>
          Remarque&nbsp;:  Apr&egrave;s avoir effectu&eacute; les modifications, cliquez sur Enregistrer les param&egrave;tres pour  que celles-ci prennent effet.</p>
        <p><strong>Configuration Internet</strong></p>
        <p>Type de connexion Internet</p>
        <p><strong>IPv6 -  automatique</strong></p>
        <p>S&eacute;lectionnez <strong>Activ&eacute;</strong> pour utiliser automatiquement  IPv6 pour les attributions d'adresses r&eacute;seau.</p>
        <p><strong>DUID</strong></p>
        <p>Il  s'agit de la valeur IPv6 DUID (DHCP pour identifiant unique IPv6) que le  routeur g&eacute;n&egrave;re de mani&egrave;re automatique.</p>
        <p><strong>Configuration du r&eacute;seau</strong></p>
        <p><strong>Tunnel iPv6</strong></p>
        <p>Pour  utiliser un Tunnel iPv6, <strong>IPv6 &ndash;  automatique</strong> doit &ecirc;tre d&eacute;sactiv&eacute;. Un Tunnel iPv6 permet &agrave; votre routeur  d'envoyer des adresses IP IPv6 sur des r&eacute;seaux IPv4. S&eacute;lectionnez <strong>Configuration automatique</strong> pour que  votre routeur prenne automatiquement en charge ces param&egrave;tres (tels que les  pr&eacute;fixes et les masques d'adresses). S&eacute;lectionnez <strong>Configuration manuelle</strong> pour modifier ces param&egrave;tres manuellement.</p>
        <p><strong>Pr&eacute;fixe</strong></p>
        <p>Saisissez  l'adresse du pr&eacute;fixe utilis&eacute; pour le tunnel fourni par votre fournisseur  d'acc&egrave;s.</p>
        <p><strong>Longueur du  pr&eacute;fixe</strong></p>
        <p>Saisissez  la longueur du pr&eacute;fixe utilis&eacute; pour le tunnel fourni par votre fournisseur  d'acc&egrave;s.</p>
        <p><strong>Border  Relay</strong></p>
        <p>Saisissez  l'adresse du Border Relay utilis&eacute; pour le tunnel fourni par votre fournisseur  d'acc&egrave;s.</p>
        <p><strong>Masque  d'adresse IPv4</strong></p>
        <p>Saisissez  la longueur du masque d'adresse IPv4 utilis&eacute; pour le tunnel fourni par votre  fournisseur d'acc&egrave;s.</p>
        <p class=option style='mso-line-height-alt:.75pt'><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'>Remarque&nbsp;:  pour plus d'informations, consultez le Guide de l'utilisateur disponible en  ligne, &agrave; l'adresse <b><u><a
