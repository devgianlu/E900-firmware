...
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:Pages>2</o:Pages>
  <o:Words>275</o:Words>
  <o:Characters>1573</o:Characters>
     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        height:.75pt'>
        <h1><span lang=FR style='color:#2971B9;mso-ansi-language:FR'>Sécurité&nbsp;-&nbsp;Pare-feu</span><span
        lang=EN-US style='color:black'><o:p></o:p></span></h1>
        <p class=body><span lang=FR style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:FR'>Remarque&nbsp;: après avoir effectué
        vos modifications, cliquez sur <span class=bold>Enregistrer les
        paramètres</span> pour les valider.</span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=heading2><span lang=FR style='font-size:13.0pt;font-family:
        Arial;color:black;mso-ansi-language:FR'>Pare-feu</span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><strong>Protection pare-feu SPI  IPv4/IPv6</strong></p>
        <p class=option>La protection pare-feu SPI permet de prot&eacute;ger votre r&eacute;seau local des  menaces provenant d'Internet.<span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=heading3><span lang=FR style='font-family:Arial;color:black;
        mso-ansi-language:FR'>Filtre Internet</span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span class=bold><span lang=FR style='font-size:10.0pt;
        font-family:Arial;color:black;mso-ansi-language:FR'>Filtrage des
        requêtes Internet anonymes</span></span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=FR style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:FR'>Ce filtre bloque les requêtes
        Internet émanant de sources inconnues, comme les requêtes ping.</span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=FR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:FR'>Filtrage multidiffusion</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=FR style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:FR'>Ce filtre bloque la multidiffusion qui
        permet à une transmission d'atteindre simultanément plusieurs
        destinataires sur votre réseau local. </span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><strong>Filtrage de redirection NAT  Internet pour IPv4 - Internet uniquement</strong></p>
        <p>Ce filtre emp&ecirc;che un  ordinateur local d'utiliser une URL ou une adresse Internet IPv4 pour acc&eacute;der  au serveur local. </p>
        <p class=option><b><span lang=FR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:FR'>Filtrage IDENT (port 113)</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'>
          <o:p></o:p>
        </span></p>
        <p class=option><span lang=FR style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:FR'>Ce filtre empêche l'analyse du
        port&nbsp;113 par des périphériques situés sur Internet. </span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=heading2><span lang=FR style='font-size:13.0pt;font-family:
        Arial;color:black;mso-ansi-language:FR'>Filtre Web</span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=FR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:FR'>Proxy</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=FR style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:FR'>Ce filtre bloque l'utilisation de
        serveurs proxy Internet. </span><span lang=EN-US style='font-size:10.0pt;
        ...
        <p class=option><span lang=FR style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:FR'>Ce filtre bloque l'utilisation de
        Java, ce qui signifie que vous ne pourrez sans doute pas accéder au
        contenu Java de sites Web. </span><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=FR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:FR'>ActiveX</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=FR style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:FR'>Ce filtre bloque l'utilisation
        d'ActiveX, ce qui signifie que vous ne pourrez sans doute pas accéder
        au contenu ActiveX de sites Web. </span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=FR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:FR'>Cookies</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=FR style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:FR'>Ce filtre bloque les cookies, qui sont
        stockés sur votre ordinateur et utilisés par les sites Web avec
        lesquels vous effectuez des interactions.</span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        ...
        FR'>Remarque&nbsp;: pour plus d'informations, consultez le Guide de
        l'utilisateur disponible en ligne, à l'adresse <b><u><a
