...
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:Created>2011-03-18T08:48:00Z</o:Created>
  <o:LastSaved>2011-03-18T08:52:00Z</o:LastSaved>
  <o:Pages>2</o:Pages>
  <o:Words>298</o:Words>
  ...
  <o:CharactersWithSpaces>1999</o:CharactersWithSpaces>
...
document.title="Security - Firewall (Protezione - Firewall)";
</script>
<!--[if gte mso 9]><xml>
     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:6;height:18.75pt'>
        ...
        Arial;color:white'>Guida</span></b></span><b><span lang=EN-US
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        height:.75pt'>
        <h1><span lang=FR style='color:#2971B9;mso-ansi-language:FR'>Security -
        Firewall (Protezione - Firewall)</span><span lang=EN-US
        style='color:black'><o:p></o:p></span></h1>
        <p class=body><span lang=FR style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:FR'>Nota: dopo aver apportato le
        modifiche desiderate, fare clic su <span class=bold>Save Settings</span>
        (Salva impostazioni) per applicare le modifiche.</span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=heading2><span lang=EN-US style='font-size:13.0pt;font-family:
        Arial;color:black'>Firewall</span><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><strong>Protezione firewall SPI IPv4/IPv6</strong></p>
        <p>Questa opzione protegge la  rete locale dalle minacce via Internet. </p>
        <p class=option><span lang=FR style='font-family:Arial;color:black;
        mso-ansi-language:FR'>Internet Filter (Filtro Internet)</span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'>
          <o:p></o:p>
        </span></p>
        <p class=option><span class=bold><span lang=FR style='font-size:10.0pt;
        font-family:Arial;color:black;mso-ansi-language:FR'>Filter Anonymous
        Internet Requests</span></span><span lang=FR style='font-size:10.0pt;
        font-family:Arial;color:black;mso-ansi-language:FR'>(Filtro richieste
        Internet anonime)</span><span lang=EN-US style='font-size:10.0pt;
        font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=FR style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:FR'>Questo filtro blocca le richieste
        Internet provenienti da origini sconosciute, come le richieste ping.</span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=FR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:FR'>Filter Multicast</span></b><span
        lang=FR style='font-size:10.0pt;font-family:Arial;color:black;
        mso-ansi-language:FR'>(Filtro multicast)</span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=FR style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:FR'>Questo filtro blocca il multicast che
        consente a una trasmissione singola di raggiungere contemporaneamente
        destinatari specifici all'interno della rete locale. </span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><strong>Filtro reindirizzamento NAT Internet solo per  Internet IPv4</strong></p>
        <p class=option>Questo  filtro viene utilizzato per evitare che un computer locale utilizzi un  indirizzo URL o un indirizzo Internet IPv4 per accedere al server locale.</p>
        <p class=option><b><span lang=FR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:FR'>Filter IDENT (Port 113)</span></b><span
        lang=FR style='font-size:10.0pt;font-family:Arial;color:black;
        mso-ansi-language:FR'>(Filtro IDENT - Porta 113) </span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=FR style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:FR'>Questo filtro impedisce ai
        dispositivi esterni alla rete locale di sottoporre a scansione la porta
        113. </span><span lang=EN-US style='font-size:10.0pt;font-family:Arial;
        color:black'><o:p></o:p></span></p>
        <p class=heading2><span lang=FR style='font-size:13.0pt;font-family:
        Arial;color:black;mso-ansi-language:FR'>Web Filter (Filtro Web)</span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=FR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:FR'>Proxy</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=FR style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:FR'>Questo filtro blocca l'utilizzo di
        server proxy Internet. </span><span lang=EN-US style='font-size:10.0pt;
        font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=FR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:FR'>Java</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=FR style='font-size:10.0pt;font-family:Arial;
        color:black;mso-ansi-language:FR'>Questo filtro blocca Java, impedendo
        la visualizzazione dei contenuti Java presenti nei siti Web. </span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>ActiveX</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Questo filtro blocca
        ActiveX, impedendo la visualizzazione dei contenuti ActiveX presenti
        nei siti Web. </span><span lang=EN-US style='font-size:10.0pt;
        font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Cookies</span></b><span
        lang=ES-MX style='font-size:10.0pt;font-family:Arial;color:black;
        mso-ansi-language:ES-MX'>(Cookie)</span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Questo filtro blocca i
        cookie, ovvero i dati memorizzati sul computer e utilizzati durante le interazioni
        con i siti Web.</span><span lang=EN-US style='font-size:10.0pt;
        font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option style='mso-line-height-alt:.75pt'><span lang=FR
        style='font-size:10.0pt;font-family:Arial;color:black;mso-ansi-language:
        FR'>Nota: per ulteriori informazioni, consultare <st1:PersonName
        ProductID="la Guida" w:st="on">la Guida</st1:PersonName> per l'utente
        online disponibile sul sito <b><u><a href="http://www.linksys.com">www.linksys.com<span
        style='font-weight:normal'>.</span></a></u></b></span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        </td>
       ...
       <tr style='mso-yfti-irow:8;mso-yfti-lastrow:yes;height:33.75pt'>
        ...
        <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
         ...
         <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:
          ...
          text-decoration:none;text-underline:none'>Chiudi</span></a></span></b><span
          lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
          </td>
          ...
          text-decoration:none;text-underline:none'>Stampa</span></a></span></b><span
          lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
          </td>
          <td width=10 style='width:7.2pt;padding:0cm 0cm 0cm 0cm;height:11.25pt'>
          <p class=MsoNormal><span lang=EN-US style='font-size:9.0pt;
