...
<![endif]-->
<TITLE>Configurazione IPv6 </TITLE>
     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:6;height:18.75pt'>
        ...
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:white'>Guida&nbsp;&nbsp;&nbsp;
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        height:.75pt'>
        <h1 class="STYLE1">Configurazione &ndash; Configurazione IPv6 </h1>
        <p>IPv6  &egrave; un nuovo protocollo IP che utilizza intestazioni di pacchetti semplificate e  richiede l'IPSec come requisito essenziale di interoperabilit&agrave;. &Egrave; provvisto  inoltre di supporto ottimizzato per dispositivi IP mobili e di elaborazione.<br>
          Nota:  dopo aver apportato le modifiche desiderate, fare clic su Save Settings (Salva  impostazioni) per applicare le modifiche.</p>
        <p><strong>Internet Setup (Configurazione  Internet)</strong></p>
        <p>Internet Connection Type (Tipo di  connessione Internet)</p>
        <p><strong>IPv6 -  Automatico</strong></p>
        <p>Selezionare <strong>Enabled</strong> (Attivato) per utilizzare  automaticamente il protocollo IPv6 per tutti gli indirizzi di rete.</p>
        <p><strong>DUID</strong></p>
        <p>Questo  &egrave; il valore IPv6 DUID (DHCP per identificativo IPv6) che viene generato  automaticamente dal router.</p>
        <p><strong>Network Setup (Configurazione rete)</strong></p>
        <p><strong>6&deg; tunnel</strong></p>
        Per utilizzare il 6&deg; tunnel, <strong>IPv6  &ndash; Automatico</strong> deve essere disattivato. Un 6&deg; tunnel consente al router di  inviare indirizzi IP IPv6 attraverso reti IPv4. Selezionare <strong>Automatic Configuration</strong> (Configurazione  automatica) per consentire al router di gestire queste impostazioni (come  prefissi e maschere indirizzi) automaticamente. Selezionare <strong>Manual Configuration</strong> (Configurazione  manuale) per modificare queste impostazioni manualmente.
        <p><strong>Prefisso</strong></p>
        <p>Immettere  l'indirizzo del prefisso utilizzato per il tunnel fornito dal provider di  servizi Internet.</p>
        <p><strong>Lunghezza  prefisso</strong></p>
        <p>Immettere  la lunghezza del prefisso utilizzata per il tunnel fornito dal provider di  servizi Internet.</p>
        <p><strong>Inoltro  bordo</strong></p>
        <p>Immettere  l'indirizzo dell'inoltro bordo utilizzato per il tunnel fornito dal provider di  servizi Internet.</p>
        <p><strong>Maschera indirizzo  IPv4</strong></p>
        <p>Immettere  la lunghezza della maschera indirizzo IPv4 utilizzata per il tunnel fornito dal  provider di servizi Internet.</p>
        <p class=option style='mso-line-height-alt:.75pt'><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'>Nota: per ulteriori  informazioni, consultare la Guida per l'utente online disponibile sul sito <b><u><a
