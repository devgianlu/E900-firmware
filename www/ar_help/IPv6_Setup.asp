...
<![endif]-->
<TITLE>IPv6 Setup (إعداد IPv6)</TITLE>
     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        height:.75pt'>
        <h1><span lang=EN-US style='font-size:16.0pt;color:#2971B9'>Setup (الإعداد) &ndash; IPv6 Setup (إعداد IPv6)</span></h1>
        <p>IPv6 هو بروتوكول IP جديد يستخدم رؤوس الحزم المبسطة ويتطلب IPSec كمتطلب أساسي للتشغيل المتداخل. كما أدى إلى تحسين اعتماد أجهزة الكمبيوتر وIP المتنقلة.<br>
          ملاحظة: بعد إجراء التغييرات، انقر فوق Save Settings (حفظ الإعدادات) لتطبيق التغييرات.</p>
        <p><strong>Internet Setup (إعداد إنترنت)</strong></p>
        <p>Internet Connection Type (نوع اتصال إنترنت)</p>
        <strong>IPv6 - Automatic ‏(IPv6 - تلقائي)</strong>
        <p>حدد <strong>Enabled (ممكّن)</strong> لاستخدام IPv6 تلقائياً لكافة عناوين الشبكة.</p>
        <p><strong>DUID</strong></p>
        <p>هذه هي قيمة IPv6 DUID ‏(DHCP لمعرّف IPv6 الفريد) التي سيقوم الموجّه بإنشائها تلقائياً.</p>
        <p><strong>Network Setup (إعداد الشبكة)</strong></p>
        <p><strong>6rd Tunnel (نفق 6rd)</strong></p>
        لاستخدام نفق 6rd، يجب تعطيل <strong>IPv6 &ndash; Automatic ‏(IPv6 - تلقائي</strong>). يسمح نفق 6rd للموجّه بإرسال عناوين IPv6 IP عبر شبكات IPv4. حدد <strong>Automatic Configuration (تكوين تلقائي)</strong> ليقوم الموجّه بمعالجة هذه الإعدادات (مثل البادئات وأقنعة العناوين) تلقائياً. حدد <strong>Manual Configuration (تكوين يدوي)</strong> لتغيير هذه الإعدادات يدوياً.
        <p><strong>Prefix (البادئة)</strong></p>
        <p>أدخل عنوان البادئة المستخدَم للنفق الذي أعطاه لك موفّر خدمة إنترنت.</p>
        <p><strong>Prefix Length (طول البادئة)</strong></p>
        <p>أدخل طول البادئة المستخدَم للنفق الذي أعطاه لك موفّر خدمة إنترنت.</p>
        <p><strong>Border Relay (ترحيل الحدود)</strong></p>
        <p>أدخل عنوان ترحيل الحدود المستخدَم للنفق الذي أعطاه لك موفّر خدمة إنترنت.</p>
        <p><strong>IPv4 Address Mask (قناع عنوان IPv4)</strong></p>
        <p>أدخل طول قناع عنوان IPv4 المستخدَم للنفق الذي أعطاه لك موفّر خدمة إنترنت.</p>
