...
<![endif]-->
<title>Firewall (جدار الحماية)</title>
     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:6;height:18.75pt'>
        ...
        height:18.75pt'>
        <p align=left style='margin:0cm;margin-bottom:.0001pt;text-align:left'><b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:white'>التعليمات&nbsp;&nbsp;&nbsp;
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        height:.75pt'>
        <h1><span lang=EN-US style='font-size:16.0pt;color:#2971B9'>Security (الأمان) &#8211; Firewall (جدار الحماية)</span><span lang=EN-US style='color:black'><o:p></o:p></span></h1>
        <p class=body><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>ملاحظة: بعد إجراء التغييرات، انقر فوق <span
        class=bold>Save Settings (حفظ الإعدادات)</span> لتطبيق التغييرات.<o:p></o:p></span></p>
        <p class=heading2><span style='font-size:13.0pt;font-family:
        Arial;color:black' lang=EN-US><strong>Firewall (جدار الحماية)</strong></span><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><strong>حماية جدار حماية IPv4/IPv6 SPI</strong><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>تساعد حماية جدار حماية SPI في حماية الشبكة المحلية من تهديدات إنترنت.
          <o:p></o:p></span></p>
        <p class=heading3 STYLE1><span lang=EN-US style='font-family:Arial;color:black'>Internet Filter (تصفية إنترنت)</span><span lang=EN-US style='font-size:10.0pt;font-family:Arial;
        color:black'><o:p></o:p></span></p>
        <p class=option><span class=bold><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'>Filter Anonymous Internet Requests (تصفية طلبات إنترنت المجهولة)</span></span><span lang=EN-US style='font-size:10.0pt;
        font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>يقوم عامل التصفية هذا بحظر طلبات إنترنت مجهولة المصدر، مثل طلبات Ping.<o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Filter Multicast (تصفية البث المتعدد)</span></b><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>يقوم عامل التصفية هذا بحظر البث المتعدد، الذي يسمح بوصول إرسال فردي إلى مستلمين محددين في الوقت نفسه ضمن شبكتك المحلية. <o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'><strong>Filter Internet NAT Redirection for IPv4 Internet Only (تصفية إعادة توجيه ترجمة عنوان الشبكة (NAT) عبر إنترنت لإنترنت IPv4 فقط)</strong>
          <o:p></o:p></span></b></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>يقوم عامل التصفية هذا بمنع كمبيوتر محلي من استخدام عنوان URL أو عنوان IPv4 إنترنت للوصول إلى الخادم المحلي.
<o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Filter IDENT ‏(Port 113) (تعريف عامل التصفية (المنفذ 113))</span></b><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>يقوم عامل التصفية هذا بالحفاظ على منفذ 113 كي لا يتم مسحه بواسطة أجهزة من إنترنت. <o:p></o:p></span></p>
        <p class=heading2><span lang=EN-US style='font-size:13.0pt;font-family:
        Arial;color:black'>Web Filter (تصفية ويب)</span><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Proxy (الوكيل)</span></b><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>يقوم عامل التصفية هذا بحظر استخدام خوادم وكيل إنترنت. <o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Java</span></b><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>يقوم عامل التصفية هذا بحظر Java، لذا قد لا يمكنك الوصول إلى محتوى Java على مواقع ويب. <o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>ActiveX</span></b><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>يقوم عامل التصفية هذا بحظر ActiveX، لذا قد لا يمكنك الوصول إلى محتوى ActiveX على مواقع ويب. <o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Cookies (ملفات تعريف الارتباط)</span></b><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>يقوم عامل التصفية هذا بحظر ملفات تعريف الارتباط، وهي البيانات التي يتم تخزينها على الكمبيوتر واستخدامها بواسطة مواقع ويب عند تفاعلك معها.<o:p></o:p></span></p>
        <p class=option style='mso-line-height-alt:.75pt'><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'>ملاحظة: للحصول على مزيد من المعلومات، راجع دليل المستخدم على إنترنت على الموقع <b><u><a
       ...
       <tr style='mso-yfti-irow:8;mso-yfti-lastrow:yes;height:33.75pt'>
        ...
        <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
         ...
         <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:
          ...
          text-decoration:none;text-underline:none'>إغلاق</span></a></span></b><span
          lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
          </td>
          ...
          text-decoration:none;text-underline:none'>طباعة</span></a></span></b><span
          lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
          </td>
          <td width=10 style='width:7.2pt;padding:0cm 0cm 0cm 0cm;height:11.25pt'>
          <p class=MsoNormal><span lang=EN-US style='font-size:9.0pt;
