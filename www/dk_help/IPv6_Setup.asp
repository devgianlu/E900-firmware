...
<![endif]-->
<TITLE>IPv6-konfiguration </TITLE>
     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:6;height:18.75pt'>
        ...
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:white'>Hjælp&nbsp;&nbsp;&nbsp;
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        height:.75pt'>
        <h1 class="STYLE1">Konfiguration &ndash; IPv6-konfiguration </h1>
        <p>IPv6  er en ny IP-protokol, der anvender forenklede pakkehoveder og kr&aelig;ver IPSec som  en grundl&aelig;ggende krav for interoperabilitet. Den har ogs&aring; forbedret  underst&oslash;ttelse for mobile IP- og computerenheder.<br>
          Bem&aelig;rk:  N&aring;r du har foretaget &aelig;ndringerne, skal du klikke p&aring; Save Settings (Gem  Indstillinger) for at anvende dine &aelig;ndringer.</p>
        <p><strong>Konfiguration af internet</strong></p>
        <p>Forbindelsestype for internet</p>
        <p><strong>IPv6 -  Automatisk</strong></p>
        <p>V&aelig;lg <strong>Enabled</strong> (Aktiveret) for at bruge  IPv6 automatisk for alle netv&aelig;rksadresser.</p>
        <p><strong>DUID</strong></p>
        <p>Dette  er den IPv6 DUID-v&aelig;rdi (DHCP for IPv6 Unique Identifier), som routeren opretter  automatisk.</p>
        <p><strong>Netv&aelig;rkskonfiguration</strong></p>
        <p><strong>6. tunnel</strong></p>
        <p>For  at bruge den 6. tunnel skal <strong>IPv6 &ndash;  Automatic</strong> (IPv6 - Automatisk) v&aelig;re deaktiveret. En 6. tunnel giver routeren  mulighed for at sende IPv6 IP-adresser over IPv4-netv&aelig;rk. V&aelig;lg <strong>Automatic Configuration</strong> (Automatisk  konfiguration), s&aring; din router kan h&aring;ndtere disse indstillinger automatisk  (f.eks. pr&aelig;fikser og adressemasker). V&aelig;lg <strong>Manual  Configuration</strong> (Manuel konfiguration) for at &aelig;ndre disse indstillinger  manuelt.</p>
        <p><strong>Pr&aelig;fiks</strong></p>
        <p>Indtast  den pr&aelig;fiksadresse, der bruges til den tunnel, som leveres af din  internetudbyder.</p>
        <p><strong>L&aelig;ngde af  pr&aelig;fiks</strong></p>
        <p>Indtast den pr&aelig;fiksl&aelig;ngde, der bruges til den tunnel, som leveres af din  internetudbyder.</p>
        <p><strong>Kantrel&aelig;</strong></p>
        <p>Indtast  det kantrel&aelig;, der bruges til den tunnel, som leveres af din internetudbyder.</p>
        <p><strong>IPv4-adressemaske</strong></p>
        <p>Indtast  den IPv4-adressemaske, der bruges til den tunnel, som leveres af din internetudbyder.</p>
        <p class=option style='mso-line-height-alt:.75pt'><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'>Bem&aelig;rk: Se online-brugervejledningen p&aring; <b><u><a
        href="http://www.linksys.com">www.linksys.com</a></u></b>
            <o:p></o:p></span>for at f&aring; flere oplysninger.</p>
        </td>
       ...
       <tr style='mso-yfti-irow:8;mso-yfti-lastrow:yes;height:33.75pt'>
        ...
        <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
         ...
         <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:
          ...
          text-decoration:none;text-underline:none'>Luk</span></a></span></b><span
          ...
          text-decoration:none;text-underline:none'>Udskriv</span></a></span></b><span
          lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
          </td>
          <td width=10 style='width:7.2pt;padding:0cm 0cm 0cm 0cm;height:11.25pt'>
          <p class=MsoNormal><span lang=EN-US style='font-size:9.0pt;
