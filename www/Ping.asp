...
<input type=hidden name=commit value=0>
      <TABLE height=100 cellSpacing=3 width=542 bgColor=#ffffff border=0>
		...
		<img border="0" src="/image/linksys_logo.png" class=LOGO></td>
                ...
                <font face="Arial" style="font-size: 9pt" color="#FFFFFF"> <script>Capture(adbutton.ping)</script>&nbsp;&nbsp;&nbsp; </font></b></td>
...
<script>
var ping_string = new Array("Network is unreachable", __T(tracert.unreach),
                            "packets transmitted", __T(ping.pkttr),
                            "packets received", __T(ping.pktrx),
                            "packet loss", __T(ping.pktloss),
                            "data bytes", __T(ping.databyte),
                            "ping statistics", __T(ping.datastat),
                            "round-trip min/avg/max", __T(ping.roundtrip),
                            "bytes from", __T(ping.bytefrom),
                            "Time", __T(summary.tmofday),
...
for(var i=0 ; table[i] ; i++) {
		...
		document.write("<p align=\"<% ui_position("rtl_right", ""); %>\"><font face=\"Arial\" style=\"font-size: 8pt\">"+table[i]+"</font></td></tr>");
			...
			<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#5b5b5b" width="234" height="19">
              <tr>
                <td height="15" width="106" bgcolor="#8C8E8C">
                <p align="center"><span style="font-weight: 700">
                <font face="Arial" style="font-size: 8pt" color="#FFFFFF"><A href="javascript:to_close(document.ping)"><script>Capture(sbutton.close)</script></A><a name="#"></a></font></span></td>
                <td height="12" width="8"></td>
                <td height="15" width="107" bgcolor="#8c8e8c">
                <p align="center"><span style="font-weight: 700">
                <font face="Arial" style="font-size: 8pt" color="#FFFFFF"><A href="javascript:to_stop(document.ping)"><script>Capture(sbutton.stop)</script></A></font></span></td>
                <td height="12" width="8"></td>
