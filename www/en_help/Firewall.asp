     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        height:.75pt'>
        <h1><span lang=EN-US style='font-size:16.0pt;color:#2971B9'>Security
        ...
        Arial;color:black'>Note: After you have made your changes, click <span
        class=bold>Save Settings</span> to apply your changes.<o:p></o:p></span></p>
        <p class=heading2><span style='font-size:13.0pt;font-family:
        Arial;color:black' lang=EN-US><strong>Firewall</strong></span><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><strong>IPv4/IPv6 SPI Firewall  Protection</strong><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>SPI firewall protection helps protect your local network from Internet  threats.
          <o:p></o:p></span></p>
        <p class=heading3 STYLE1><span lang=EN-US style='font-family:Arial;color:black'>Internet
        Filter</span><span lang=EN-US style='font-size:10.0pt;font-family:Arial;
        color:black'><o:p></o:p></span></p>
        <p class=option><span class=bold><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'>Filter Anonymous Internet
        Requests</span></span><span lang=EN-US style='font-size:10.0pt;
        font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>This filter blocks Internet requests from unknown
        sources, such as ping requests.<o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Filter Multicast</span></b><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>This filter blocks multicasting, which allows a
        single transmission to simultaneously reach specific recipients within
        your local network. <o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'><strong>Filter Internet NAT  Redirection for IPv4 Internet Only</strong>
          <o:p></o:p></span></b></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>This filter prevents a local computer from using a URL or Internet IPv4  address to access the local server.
<o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Filter IDENT (Port 113)</span></b><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>This filter keeps port 113 from being scanned by
        devices from the Internet. <o:p></o:p></span></p>
        <p class=heading2><span lang=EN-US style='font-size:13.0pt;font-family:
        Arial;color:black'>Web Filter</span><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Proxy</span></b><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>This filter blocks the use of Internet proxy
        servers. <o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Java</span></b><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>This filter blocks Java, so you may not be able to
        access Java content on websites. <o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>ActiveX</span></b><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>This filter blocks ActiveX, so you may not be able
        to access ActiveX content on websites. <o:p></o:p></span></p>
        <p class=option><b><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>Cookies</span></b><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'>This filter blocks cookies, which are data stored on
        your computer and used by websites when you interact with them.<o:p></o:p></span></p>
        <p class=option style='mso-line-height-alt:.75pt'><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'>Note: For more
        information, refer to the online User Guide at <b><u><a
       ...
       <tr style='mso-yfti-irow:8;mso-yfti-lastrow:yes;height:33.75pt'>
        ...
        <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
         ...
         <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:
          ...
          text-decoration:none;text-underline:none'>Close</span></a></span></b><span
          lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
          </td>
          ...
          text-decoration:none;text-underline:none'>Print</span></a></span></b><span
          lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
          </td>
          <td width=10 style='width:7.2pt;padding:0cm 0cm 0cm 0cm;height:11.25pt'>
          <p class=MsoNormal><span lang=EN-US style='font-size:9.0pt;
