      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr>
		...
		<tr style='mso-yfti-irow:2;height:42.75pt'>
			<td width=761 colspan=4 style='width:570.75pt;background:#2971B9;padding:0cm 0cm 0cm 0cm;height:42.75pt'>
				<p style='margin:0cm;margin-bottom:.0001pt'><span lang=EN-US
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        height:.75pt'>
        <h1><span lang=EN-US style='font-size:16.0pt;color:#2971B9'>Setup &ndash; IPv6 Setup</span></h1>
        <p>IPv6  is a new IP protocol that uses simplified packet headers and requires IPSec as  a fundamental interoperability requirement. It also has improved support for  mobile IP and computing devices.<br>
          Note:  After you have made your changes, click Save Settings to apply your  changes.</p>
        <p><strong>Internet Setup</strong></p>
        <p>Internet Connection Type</p>
        <strong>IPv6 - Automatic</strong>
        <p>Select <strong>Enabled</strong> to automatically use IPv6  for all network addressing.</p>
        <p><strong>DUID</strong></p>
        <p>This  is the IPv6 DUID (DHCP for IPv6 Unique Identifier) value that the router  automatically generates.</p>
        <p><strong>Network Setup</strong></p>
        <p><strong>6rd Tunnel</strong></p>
        To use 6rd Tunnel, <strong>IPv6 &ndash;  Automatic</strong> must be disabled. A 6rd Tunnel allows your router to send IPv6 IP  addresses over IPv4 networks. Select <strong>Automatic  Configuration</strong> for your router to handle these settings (such as prefixes  and address masks) automatically. Select <strong>Manual  Configuration</strong> to change these settings manually.
        <p><strong>Prefix</strong></p>
        <p>Enter  the prefix address used for the tunnel provided by your ISP.</p>
        <p><strong>Prefix  Length</strong></p>
        <p>Enter  the prefix length used for the tunnel provided by your ISP.</p>
        <p><strong>Border  Relay</strong></p>
        <p>Enter  the border relay address used for the tunnel provided by your ISP.</p>
        <p><strong>IPv4  Address Mask</strong></p>
        <p>Enter  the IPv4 address mask length used for the tunnel provided by your ISP.</p>
