...
function to_submit(f)
{
	...
	{
		window.opener.rename_device(f.new_name.value);
		window.close();
	}	
}
  ...
  <TR>
        ...
        <TR>
          <TH width=834>
            <TABLE cellSpacing=0 width=448 bgColor=#ffffff 
              ...
              <TR>
                <TH vAlign=top align=right width=580 bgColor=#FFFFFF>
                <div align="left">
	...
	<img border="0" src="/image/linksys_logo.png" class=LOGO></td>
                ...
                <script>Capture(pctrl.pcontrol)</script> &nbsp;&nbsp;&nbsp; </font></b></td>
                      ...
                      <td height="25" width="420" bgcolor="#FFFFFF" colspan="2"><font face="Arial" style="font-size: 8pt"><B><script>Capture(pctrl.rndev)</script></b></font>
                      	</td>
                    ...
                    <tr>
                    	...
                    	<td   width="23" height="20" ></td>
                      	<td   width="420" height="20" colspan="2"><font face="Arial" style="font-size: 8pt;"><script>Capture(pctrl.ennewname)</script>&nbsp;&nbsp;<b><script>document.write(sel_dev_name)</script></b></font></td>
			...
			<input maxlength="32" style="width:240" name="new_name" onBlur=valid_name(this,"DeviceName")>
                      </font></td>
                      <td height="20" width="14" bgcolor="#FFFFFF"></td>
                      </tr>
			...
			<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#5b5b5b" id="AutoNumber4" width="335" height="19">
              <tr>
                ...
                <p align="center">
        <font color="#FFFFFF" style="font-size: 8pt; font-weight: 700" face="Arial"> <A href="javascript:to_submit(document.PC_renamedev)"><script>Capture(wlanwscpopup.button)</script></A></font></td>
