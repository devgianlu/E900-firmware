...
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastSaved>2011-03-18T08:54:00Z</o:LastSaved>
  <o:Pages>2</o:Pages>
  <o:Words>255</o:Words>
...
document.title="Segurança – Firewall";
</script>
<!--[if gte mso 9]><xml>
     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:6;height:18.75pt'>
        ...
        Arial;color:white'>Ajuda</span></b></span><b><span lang=EN-US
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        height:.75pt'>
        <h1><span lang=PT-BR style='color:#2971B9;mso-ansi-language:PT-BR'>Segurança
        &#8211; Firewall</span><span lang=EN-US style='color:black'><o:p></o:p></span></h1>
        <p class=body><span lang=PT-BR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:PT-BR'>Nota: Após ter efectuado as
        suas alterações, clique <st1:PersonName
        ProductID="em Guardar Definições" w:st="on">em <span class=bold>Guardar
         Definições</span></st1:PersonName> para aplicar as suas alterações.</span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=heading2><span lang=PT-BR style='font-size:13.0pt;font-family:
        Arial;color:black;mso-ansi-language:PT-BR'>Firewall</span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><strong>Protec&ccedil;&atilde;o da firewall de SPI  IPv4/IPv6</strong></p>
        <p>A protec&ccedil;&atilde;o da firewall de  SPI permite proteger a sua rede local das amea&ccedil;as da Internet. </p>
        <p class=option><span lang=PT-BR style='font-family:Arial;color:black;
        mso-ansi-language:PT-BR'>Filtro da Internet</span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'>
          <o:p></o:p>
        </span></p>
        <p class=option><span class=bold><span lang=PT-BR style='font-size:
        10.0pt;font-family:Arial;color:black;mso-ansi-language:PT-BR'>Filtrar
        pedidos de Internet anónimos</span></span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=PT-BR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:PT-BR'>Este filtro bloqueia os
        pedidos de Internet de fontes desconhecidas, tais como pedidos de ping.</span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=PT-BR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:PT-BR'>Filtrar multicast</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=PT-BR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:PT-BR'>Este filtro bloqueia o multicast,
        o que permite que uma única transmissão alcance simultaneamente
        destinatários específicos na sua rede local. </span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><strong>Filtrar redireccionamento de  NAT apenas para Internet IPv4</strong></p>
        <p class=option>Este filtro impede que um computador local utilize um URL ou endere&ccedil;o IP  IPv4 de Internet para aceder ao servidor local.</p>
        <p class=option><b><span lang=PT-BR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:PT-BR'>Filtrar IDENT (Porta 113)</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=PT-BR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:PT-BR'>Este filtro impede que a
        porta 113 seja procurada por dispositivos da Internet. </span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=heading2><span lang=PT-BR style='font-size:13.0pt;font-family:
        Arial;color:black;mso-ansi-language:PT-BR'>Filtro Web</span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=PT-BR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:PT-BR'>Proxy</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=PT-BR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:PT-BR'>Este filtro bloqueia a
        utilização de servidores proxy da Internet. </span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=PT-BR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:PT-BR'>Java</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=PT-BR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:PT-BR'>Este filtro bloqueia o Java,
        por isso poderá não conseguir aceder ao conteúdo Java nos web sites. </span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=PT-BR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:PT-BR'>ActiveX</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=PT-BR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:PT-BR'>Este filtro bloqueia o
        ActiveX, por isso poderá não conseguir aceder ao conteúdo ActiveX nos
        web sites. </span><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=PT-BR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:PT-BR'>Cookies</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=PT-BR style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:PT-BR'>Este filtro bloqueia os
        cookies, que são dados guardados no seu computador e utilizados por web
        sites quando interage com eles.</span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option style='mso-line-height-alt:.75pt'><span lang=PT-BR
        style='font-size:10.0pt;font-family:Arial;color:black;mso-ansi-language:
        PT-BR'>Nota: Para obter mais informações, consulte o Manual do
        utilizador online em <b><u><a href="http://www.linksys.com">www.linksys.com<span
