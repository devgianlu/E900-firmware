...
<![endif]-->
<TITLE>Configuraci&oacute;n de IPv6 </TITLE>
     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:6;height:18.75pt'>
        ...
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:white'>Ayuda&nbsp;&nbsp;&nbsp;
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        height:.75pt'>
        <h1 class="STYLE1">Configuraci&oacute;n &ndash; Configuraci&oacute;n de IPv6 </h1>
        <p>IPv6 es un nuevo protocolo IP que utiliza encabezados de paquetes  simplificados y tiene IPSec como requisito de interoperabilidad fundamental.  Tambi&eacute;n mejora la compatibilidad con IP m&oacute;vil y dispositivos inform&aacute;ticos.<br>
          Nota: Una vez realizados los cambios, haga clic en Guardar par&aacute;metros para  aplicarlos.</p>
        <p><strong>Configuraci&oacute;n de Internet</strong></p>
        <p>Tipo de conexi&oacute;n a Internet</p>
        <p><strong>IPv6 -  Autom&aacute;tico</strong></p>
        <p>Seleccione <strong>Activado</strong> para usar autom&aacute;ticamente  IPv6 para todas las direcciones de red.</p>
        <p><strong>DUID</strong></p>
        <p>Este es el valor de IPv6 DUID (DHCP for IPv6 Unique Identifier,  identificador &uacute;nico de DHCP para IPv6) que el router genera autom&aacute;ticamente.</p>
        <p><strong>Configuraci&oacute;n de red</strong></p>
        <p><strong>T&uacute;nel 6rd</strong></p>
        Para usar T&uacute;nel 6rd, <strong>IPv6 &ndash;  Autom&aacute;tico</strong> debe estar desactivado. Un t&uacute;nel 6rd permite al router enviar  direcciones IP de IPv6 mediante redes IPv4. Seleccione <strong>Configuraci&oacute;n autom&aacute;tica</strong> para que el router gestione estos  par&aacute;metros (como prefijos y m&aacute;scaras de direcci&oacute;n) autom&aacute;ticamente. Seleccione <strong>Configuraci&oacute;n manual</strong> para cambiar estos  par&aacute;metros manualmente.
        <p><strong>Prefijo</strong></p>
        <p>Introduzca  la direcci&oacute;n de prefijo utilizada para el t&uacute;nel proporcionado por el ISP.</p>
        <p><strong>Longitud de  prefijo</strong></p>
        <p>Introduzca  la longitud de prefijo utilizada para el t&uacute;nel proporcionado por el ISP.</p>
        <p><strong>Retransmisi&oacute;n  de bordes</strong></p>
        <p>Introduzca la direcci&oacute;n de retransmisi&oacute;n de bordes utilizada para el  t&uacute;nel proporcionado por el ISP.</p>
        <p><strong>M&aacute;scara de  direcci&oacute;n IPv4</strong></p>
        <p>Introduzca la longitud de m&aacute;scara de direcci&oacute;n IPv4 utilizada para el  t&uacute;nel proporcionado por el ISP.</p>
        <p class=option style='mso-line-height-alt:.75pt'><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'>Nota: Para obtener m&aacute;s informaci&oacute;n, consulte la gu&iacute;a del usuario en  l&iacute;nea en <b><u><a
