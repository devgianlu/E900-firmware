...
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:Created>2011-03-18T08:46:00Z</o:Created>
  <o:LastSaved>2011-03-18T08:47:00Z</o:LastSaved>
  <o:Pages>2</o:Pages>
  <o:Words>253</o:Words>
  <o:Characters>2888</o:Characters>
  <o:Company>bbb</o:Company>
  <o:Lines>12</o:Lines>
  <o:Paragraphs>3</o:Paragraphs>
  <o:CharactersWithSpaces>1698</o:CharactersWithSpaces>
...
document.title="Seguridad: Firewall";
</script>
<!--[if gte mso 9]><xml>
     ...
     <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
      ...
      <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
       ...
       <tr style='mso-yfti-irow:6;height:18.75pt'>
        ...
        Arial;color:white'>Ayuda</span></b></span><b><span lang=EN-US
       ...
       <tr style='mso-yfti-irow:7;height:.75pt'>
        ...
        height:.75pt'>
        <h1><span lang=ES-MX style='color:#2971B9;mso-ansi-language:ES-MX'>Seguridad:
        Firewall</span><span lang=EN-US style='color:black'><o:p></o:p></span></h1>
        <p class=body><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Nota: Una vez realizados los
        cambios, haga clic en <span class=bold>Guardar parámetros</span> para
        aplicarlos.</span><span lang=EN-US style='font-size:10.0pt;font-family:
        Arial;color:black'><o:p></o:p></span></p>
        ...
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><strong>Protecci&oacute;n de firewall SPI  IPv4/IPv6</strong><span lang=EN-US style='font-size:10.0pt;
        font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option>La protecci&oacute;n de firewall SPI ayuda a proteger la red local frente a  amenazas de Internet.</p>
        <p class=heading3><span lang=ES-MX style='font-family:Arial;color:black;
        mso-ansi-language:ES-MX'>Filtro de Internet</span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span class=bold><span lang=ES-MX style='font-size:
        10.0pt;font-family:Arial;color:black;mso-ansi-language:ES-MX'>Filtrar solicitudes
        anónimas de Internet</span></span><span lang=EN-US style='font-size:
        10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Este filtro bloquea las
        solicitudes de Internet de fuentes desconocidas como, por ejemplo,
        solicitudes de ping.</span><span lang=EN-US style='font-size:10.0pt;
        font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Filtrar multidifusión</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Este filtro bloquea la
        multidifusión, lo que permite que sólo llegue una única transmisión
        simultánea a los destinatarios especificados de la red local. </span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><strong>Filtrar redirecci&oacute;n NAT de  Internet s&oacute;lo para IPv4 de Internet</strong></p>
        <p class=option>Este filtro evita que un ordenador local use una direcci&oacute;n URL o una  direcci&oacute;n IPv4 de Internet para acceder al servidor local.</p>
        <p class=option><b><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Filtrar IDENT (Puerto 113)</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Este filtro evita que
        dispositivos de Internet escaneen el puerto 113. </span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=heading2><span lang=ES-MX style='font-size:13.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Filtro Web</span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Proxy</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Este filtro bloquea el uso
        de servidores proxy de Internet. </span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Java</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Este filtro bloquea Java,
        por lo que no podrá acceder a contenidos de Java en sitios web. </span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>ActiveX</span></b><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Este filtro bloquea ActiveX,
        por lo que no podrá acceder a contenido ActiveX de sitios web. </span><span
        lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        <p class=option><b><span lang=ES-MX style='font-size:10.0pt;font-family:
        ...
        <p class=option><span lang=ES-MX style='font-size:10.0pt;font-family:
        Arial;color:black;mso-ansi-language:ES-MX'>Este filtro bloquea las
        cookies, que son datos almacenados en su ordenador y que utilizan los
        sitios web al interactuar con ellos.</span><span lang=EN-US
        style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
        ...
        ES-MX'>Nota: Para obtener más información, consulte la guía del usuario
        en línea en <b><u><a href="http://www.linksys.com">www.linksys.com<span
       ...
       <tr style='mso-yfti-irow:8;mso-yfti-lastrow:yes;height:33.75pt'>
        ...
        <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0
         ...
         <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:
          ...
          text-decoration:none;text-underline:none'>Cerrar</span></a></span></b><span
          lang=EN-US style='font-size:10.0pt;font-family:Arial;color:black'><o:p></o:p></span></p>
          </td>
